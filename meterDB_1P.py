...
from constants_1P import DATABASE_NAME,TEXT_NAME,METER_ID,READ_DAY,DEMANT_TIME,COSTUMER_NAME
...
def insertData():
    try:
        ...
        print("SqLite veritabanına tabloya veri ekleme hatası!", error)
    finally:
        if sqliteConnection:
